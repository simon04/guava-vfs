...
public abstract class IoTestCase extends TestCase {
   ...
   */
  protected final String getTestFile(String name) throws IOException {
   ...
   */
  protected final String createTempFile() throws IOException {
    return File.createTempFile("test", null, getTempDir()).getPath();
  }
